...
public class DB {
    ...
    private static final String COMPANY_TABLE_CREATE = "create table " + COMPANY_TABLE + "(" +
            COMPANY_COLUMN_ID + " integer primary key, " + COMPANY_COLUMN_NAME + " text" + ");";
    ...
    private static final String PHONE_TABLE_CREATE = "create table " +
            PHONE_TABLE + "(" + PHONE_COLUMN_ID + " integer primary key autoincrement, " +
    ...
    private class DBHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            ...
            String[] phonesHTC = new String[]{ "Sensation", "Desire",
                    "Wildfire", "Hero" };
            String[] phonesSamsung = new String[]{ "Galaxy S II", "Galaxy Nexus",
                    "Wave" };
